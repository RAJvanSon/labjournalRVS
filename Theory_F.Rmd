...
Moreover, relating clustering to interdisciplinarity, I expect that the network becomes clustered *not* just 'randomly' but, rather, that the networks become clustered on the basis of interdisciplinarity. So:
